...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    browserify: {
      ...
      "utils-ie": {
        files: {
          'dist/pizzip-utils-ie.js': ['lib/index_IE.js']
        },
        options: {
          postBundleCB: postBundleWithLicense
        }
    ...
    uglify: {
      ...
      "pizzip-utils": {
        src: 'dist/pizzip-utils.js',
        dest: 'dist/pizzip-utils.min.js'
      },
      "pizzip-utils-ie": {
        src: 'dist/pizzip-utils-ie.js',
        dest: 'dist/pizzip-utils-ie.min.js'
      }
    }
  });
